...
class KecapUpdate extends React.Component{
    constructor(props){
        super(props);
    ...
    handleSubmit(event){
        ...
        fetch("http://127.0.0.1:8080/api/kecap", payload)
            ...
            .then(
                (result) => {
                    alert("kecap " + result.data.nama + " berhasil diupdate di database");
                }
            ).catch(() => {
